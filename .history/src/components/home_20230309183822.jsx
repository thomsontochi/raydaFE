                                            ...
                                            <div className="_src_components_Main_Main_module__row">
                                                ...
                                                {gadgets.map((gadget) => (
                                                    ...
                                                    <div className="_src_components_resets_module__clapyResets _src_components_Main_Card_Card_module__root">
                                                        ...
                                                        <img src={gadget.image} alt="" className="_src_components_Main_Main_module__image5 _src_components_Main_Card_Card_module__image"/>
                                                        ...
                                                        <div className="_src_components_Main_Card_Card_module__info">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="_src_components_Main_Card_Card_module__text4">
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                className="_src_components_Main_Card_Card_module__label">
                                                                                {gadget.name}</span><span
                                                            ...
                                                            <div className="_src_components_Main_Main_module__modernOfficeTableDeskComputerT3" key={gadget.id}>
                                                            {gadget.title}
                                                            </div>
                                                            <div className="_src_components_Main_Card_Card_module__priceOrCurrentBid">
                                                                ...
                                                                <div className="_src_components_Main_Main_module___37003" key={gadget.id}>
                                                                {gadget.bid}
                                                                </div>
                                                            </div>
